...
-- schema.sql — Saga Ops
-- ============================================================================
-- IDEMPOTENTE. Se ejecuta en cada deploy de db/ (vía docker compose
-- --profile migrate run --rm db-migrate). Contiene SOLO estructura:
-- tablas, índices, triggers, funciones SP. Sin datos.
--
-- Convenciones:
...
--
-- Para datos catálogo iniciales ver db/seed.sql.
-- ============================================================================
